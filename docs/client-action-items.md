...
범위 확인용 요약 문서: `docs/scope-confirmation.md`
...
| 고객 제공 이미지 사용 승인 | `docs/client-image-application-report.md` 기준 공개 가능/불가, 초상권 확인 결과 | 승인된 이미지만 CMS 또는 `/assets/client-smc/` 기본 이미지로 적용 |
