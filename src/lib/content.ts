...
export const copy = {
  ko: {
    ...
    signup: {
      ...
      note: "회원가입은 공개 가입 방식으로 운영하며, 실제 계정 생성은 Supabase Auth 연결 후 활성화합니다.",
      successTitle: "가입 흐름이 확인되었습니다.",
      successMessage: "실제 계정 생성과 로그인 세션은 Supabase Auth 연결 후 활성화됩니다.",
      validation: {
        required: "필수 항목을 입력해 주세요.",
        email: "올바른 이메일 주소를 입력해 주세요.",
        passwordLength: "비밀번호는 6자 이상 입력해 주세요.",
  ...
  en: {
    ...
    signup: {
      ...
      note: "Signup will operate as open registration. Real account creation will be enabled after Supabase Auth is connected.",
      successTitle: "Signup flow confirmed.",
      successMessage: "Real account creation and login sessions will be enabled after Supabase Auth is connected.",
      validation: {
        required: "Please complete this required field.",
        email: "Please enter a valid email address.",
        passwordLength: "Password must be at least 6 characters.",
  ...
  es: {
    ...
    signup: {
      ...
      note: "El registro operará como inscripción abierta. La creación real de cuenta se activará después de conectar Supabase Auth.",
      successTitle: "Flujo de registro confirmado.",
      successMessage: "La creación real de cuenta y las sesiones de inicio se activarán después de conectar Supabase Auth.",
      validation: {
        required: "Complete este campo obligatorio.",
        email: "Ingrese una dirección de email válida.",
        passwordLength: "La contraseña debe tener al menos 6 caracteres.",
